export default function Intro() {
    ...
    return (
            ...
            <section className="sec1" id="about-me">
                ...
                <p>I'm a MERN Web Developer who has a burning passion for web design and building web applications. I love learning, taking opportunities to be creative, doing hard stuff, reading science fiction books, and helping others. Don't forget to view my projects <a href="https://github.com/Milkdromeda-333" target="_blank">here</a>.</p>
